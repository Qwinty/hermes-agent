...
DEFAULT_CONFIG = {
    ...
    # Gemini 32000, Deepgram 4000, Edge 5000, Mistral 4000, NeuTTS/KittenTTS 2000).
    "tts": {
    ...
    "stt": {
        ...
        "provider": "local",  # "local" (free, faster-whisper) | "groq" | "openai" (Whisper API) | "mistral" (Voxtral Transcribe) | "elevenlabs" (Scribe) | "deepgram" | "xai"
        "local": {
