...
def _handle_send(args):
    ...
    # Unknown-extension explicit MEDIA tags are intentionally left in the body
    # by extract_media(). If the file is safe and exists, still deliver it as a
    # document and remove the directive so it is not shown as visible text.
