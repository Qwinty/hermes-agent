...
class TestPostSetup:
    ...
    def test_local_embedded_setup_materializes_profile_env(self, tmp_path, monkeypatch):
        ...
        assert profile_env.read_text() == (
            ...
            "HINDSIGHT_API_LLM_BASE_URL=https://generativelanguage.googleapis.com/v1beta/openai\n"
...
class TestSyncTurn:
    ...
    def test_sync_turn_strips_noise_from_mixed_turn_before_retaining(self, provider_with_config):
        ...
        assert "model was just switched" not in item["content"]
        assert "Remember: user prefers concise answers." in item["content"]
